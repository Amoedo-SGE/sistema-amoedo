...
CREATE TABLE `eventos` (
  ...
  `data_evento` timestamp(6) NOT NULL DEFAULT current_timestamp(6) ON UPDATE current_timestamp(6),
  `endereco_evento` varchar(255) NOT NULL,
  `responsavel` varchar(55) NOT NULL,
  `categoria` varchar(55) NOT NULL,
  `limite_participantes` varchar(55) NOT NULL,
  `orcamento` varchar(55) NOT NULL,
  `descricao` varchar(255) NOT NULL,
  `status_pagamento` varchar(55) NOT NULL
