...
<body>
  <div class="wrapper fadeInDown">
    <div class="content-login">
      ...
      <form class="box-login" method="post" action="../app/controllers/verify_login.php">
      ...
      <a href="../app/views/user/register.php" class="link">Não possui uma conta? Cadastre-se</a>
    </div>
  </div>
</body>
